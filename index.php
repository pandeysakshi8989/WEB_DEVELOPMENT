...
<head>
    <meta charset="utf-8">
    <title>HealthEasy -healthcare and support</title>
        ...
        <div class="row gx-0">
            <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center">
                    <small class="py-2"><i class="far fa-clock text-primary me-2"></i>Open:Mon
                        - Fri : 10.00 am - 4.00 pm,Sat
                        - Sun : 9.00 am - 1.00 pm </small>
                </div>
            </div>
            <div class="col-md-6 text-center text-lg-end">
                <div class="position-relative d-inline-flex align-items-center bg-primary text-white top-shape px-5">
                    <div class="me-3 pe-3 border-end py-2">
                        <p class="m-0"><i class="fa fa-envelope-open me-2"></i>healtheasy@gmail.com</p>
                    </div>
                    <div class="py-2">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Take care of your Health</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Provides full support for easy health care </h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Take care of your Health</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Provides full support for self health care</h1>
                            <a href="appointment.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Appointment</a>
                            <a href="contact.php" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Contact Us</a>
                        </div>
                    </div>
            ...
            <div class="row gx-0">
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.1s">
                    <div class="bg-primary d-flex flex-column p-5" style="height: 300px;">
                        ...
                        <a class="btn btn-light" href="/healtheasy/html/appointment.html">Appointment</a>
                    </div>
                </div>
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.3s">
                    <div class="bg-dark d-flex flex-column p-5" style="height: 300px;">
                        <h3 class="text-white mb-3 text-center">Our Team</h3>
                        <div class="d-flex justify-content-between text-white mb-3">
                            <h5 class="text-white mb-0">Doctors</h5> 
                            <h5 class="text-white mb-0">Nurses</h5>  
                        </div>
                        <div class="d-flex justify-content-between text-white mb-3">
                            <h5 class="text-white mb-0">Staff</h5> 
                            <h5 class="text-white mb-0">M.O.</h5> 
                        </div>
                        <div class="d-flex justify-content-center text-white mb-3">
                            <p class="mb-0">You find day & profession </p>   
                        </div>
                        <a class="btn btn-light" href="/healtheasy/html/team.html">See Our Team</a>
                    </div>
                </div>
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.6s">
                    <div class="bg-secondary d-flex flex-column p-5" style="height: 300px;">
                        <h3 class="text-white mb-3">Make Appointment</h3>
                        <p class="text-white">Choose your doctor timely according to your need for better results</p>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 wow zoomIn" data-wow-delay="0.6s">
                    <div class="offer-text text-center rounded p-5">
                        <h1 class="display-5 text-white">Save 40% On Your First Health Checkup</h1>
                        <p class="text-white mb-4">Concession on regular checkup</p>
                        <a href="appointment.php" class="btn btn-dark py-3 px-5 me-3">Appointment</a>
                        <a href="offer.php" class="btn btn-light py-3 px-5">Read More</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel rounded p-5 wow zoomIn" data-wow-delay="0.6s">
                        <div class="testimonial-item text-center text-white">
                            ...
                            <p class="fs-5">I am glad to tell you that HealthEasy provides best counselling session and now I am doing well at my workplace.</p>
                            <hr class="mx-auto w-25">
                            <h4 class="text-white mb-0">Monika</h4>
                        </div>
                        <div class="testimonial-item text-center text-white">
                            <img class="img-fluid mx-auto rounded mb-4" src="img/testimonial-2.jpg" alt="">
                            <p class="fs-5">I am very happy to tell that my surgery for brain tumour is successfully completed by HelathEasy Team and now I am living my greenery life.</p>
                            <hr class="mx-auto w-25">
                            <h4 class="text-white mb-0">Sonika</h4>
                        </div>
                    </div>
                </div>
            </div>
