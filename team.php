...
<html lang="en">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
            <div class="team-item">
              ...
              >
                <h4 class="mb-2">Dr. Rahul Divedi</h4>
                <p class="text-primary mb-0">Peadiatrician</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
            <div class="team-item">
              ...
              <div
                class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5"
              >
                <h4 class="mb-2">Dr. Ankita Roy</h4>
                <p class="text-primary mb-0">Physician</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 wow slideInUp" data-wow-delay="0.1s">
            <div class="team-item">
              ...
              <div
                class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5"
              >
                <h4 class="mb-2">Dr.Shyam Sharma</h4>
                <p class="text-primary mb-0">Eye Surgeon</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
            <div class="team-item">
              ...
              <div
                class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5"
              >
                <h4 class="mb-2">Dr.Gauri</h4>
                <p class="text-primary mb-0">Pscyologist</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
            <div class="team-item">
              ...
              <div
                class="team-text position-relative bg-light text-center rounded-bottom p-4 pt-5"
              >
                <h4 class="mb-2">Dr. John Abraham</h4>
                <p class="text-primary mb-0">Cardiologist</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <p class="text-danger">May not be updated. Please login</p>
</div>
</div>
  <!--list table end-->
 <!-- Newsletter Start -->
