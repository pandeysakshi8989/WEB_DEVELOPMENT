          ...
          <div class="col-lg-5">
            <div class="section-title mb-4">
              ...
              <h1 class="display-5 mb-0">
                We Offer Fair Prices for Health Treatment
              </h1>
            </div>
            <p class="mb-4">
              On Family group healthcare and checkup upto 50% concession
            </p>
            <h5
            ...
            <h1 class="wow fadeInUp" data-wow-delay="0.6s">+123456789</h1>
          </div>
          <div class="col-lg-7">
            <div
              ...
              <div class="price-item pb-4">
                <div class="position-relative">
                  ...
                  <div
                    ...
                    style="z-index: 2"
                  >
                    <h2 class="text-primary m-0">Rs.100</h2>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div class="d-flex justify-content-between mb-3">
                    <span>Professional Physician</span
                    ><i class="fa fa-check text-primary pt-1"></i>
                  </div>
              ...
              <div class="price-item pb-4">
                <div class="position-relative">
                  ...
                  <div
                    ...
                    style="z-index: 2"
                  >
                    <h2 class="text-primary m-0">Rs.50/hr</h2>
                  </div>
                </div>
                <div
                  class="position-relative text-center bg-light border-bottom border-primary py-5 p-4"
              ...
              <div class="price-item pb-4">
                <div class="position-relative">
                  ...
                  <div
                    ...
                    style="z-index: 2"
                  >
                    <h2 class="text-primary m-0">Rs.500</h2>
                  </div>
                </div>
                <div
                  class="position-relative text-center bg-light border-bottom border-primary py-5 p-4"
