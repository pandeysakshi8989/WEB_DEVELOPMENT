            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="offer.php" class="dropdown-item active">Offers</a>
                    </div>
                </div>
     ...
     <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
          <div class="col-12 text-center">
            <h1 class="display-3 text-white animated zoomIn">Latest Offers</h1>
            <a href="#" class="h4 text-white">Home</a>
            <i class="far fa-circle text-white px-2"></i>
            <a href="#" class="h4 text-white">Offer</a>
          </div>
        </div>
      </div>
      <!-- Hero End -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 wow zoomIn" data-wow-delay="0.6s">
                    <div class="offer-text text-center rounded p-5">
                        ...
                        <a href="login.php" class="btn btn-dark py-3 px-5 me-3">Login for futher details</a>
                        <a href="signup.php" class="btn btn-light py-3 px-5">Signup if not registered</a>
                    </div>
                </div>
            </div>
        </div>
