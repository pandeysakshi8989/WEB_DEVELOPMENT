...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>HealthEasy -About Us</title>
          ...
          <div class="col-lg-7">
            <div class="section-title mb-4">
              ...
              <h1 class="display-5 mb-0">
                The India's Best : Easily Available and Every Possible Facility
              </h1>
            </div>
            <h4 class="text-body fst-italic mb-4">
              Super go with your health and feel happy day and night
            </h4>
            <p class="mb-4">
              HealthEasy provides astonishing features with one-to-one
              communication,easy appoitment procedures and satisfyinga nd best
              results.
            </p>
            <div class="row g-3">
            ...
            <a
              href="/healtheasy/html/appointment.html"
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
      <div class="container">
          <div class="row g-5 mb-5">
              <div class="col-lg-12 wow zoomIn" data-wow-delay="0.3s" style="min-height: 400px;">
                <div class="rounded-top overflow-hidden">
                  <img class=" img-fluid d-block w-100"
                  style="height: 400px"src="img/award5.jpg" alt="a5">
              </div>   
              </div>
              </div><!--A1-->
                  <div class="row g-5 mt-2 justify-content-evenly">
                      <div class="col-md-3 service-item wow zoomIn" data-wow-delay="0.6s">
                          <div class="rounded-top overflow-hidden">
                              <img class="img-fluid" src="img/award1.jpg" alt="a1">
                          </div>
                      </div>
                      <div class="col-md-3 service-item wow zoomIn" data-wow-delay="0.9s">
                          <div class="rounded-top overflow-hidden">
                              <img class="img-fluid" src="img/award2.jpg" alt="a2" >
                          </div>
                          </div>
                          <div class="col-md-3 service-item wow zoomIn" data-wow-delay="0.9s">
                            <div class="rounded-top overflow-hidden">
                                <img class="img-fluid" src="img/award6.jpg" alt="a2">
                            </div>
                            </div>
          </div><!--a2-->
          <div class="row g-5 mt-2 wow fadeInUp justify-content-evenly" data-wow-delay="0.1s">
                      <div class="col-md-3 service-item wow zoomIn" data-wow-delay="0.3s">
                          <div class="rounded-top overflow-hidden">
                              <img class="img-fluid" src="img/award4.jpg" alt="a4">
                          </div>
                      </div>
                      <div class="col-md-3 service-item wow zoomIn" data-wow-delay="0.6s">
                          <div class="rounded-top overflow-hidden">
                              <img class="img-fluid" src="img/award3.jpg" alt="a3">
                          </div>
                      </div>
                      <div class="col-md-3 service-item wow zoomIn" data-wow-delay="0.9s">
                        <div class="rounded-top overflow-hidden">
                            <img class="img-fluid" src="img/award7.jpg" alt="a3">
                        </div>
                        </div>
                  </div><!--a3-->
                  </div>
