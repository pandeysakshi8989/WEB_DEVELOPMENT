...
if(isset($_GET['delete'])){
  ...
  //delete
$sql="DELETE FROM `doctor` WHERE `Serial`='$snoDelete'";
...
if ($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  $sql="UPDATE `doctor` SET `Name` = '$Name', `Profession` = '$Profession',`Day` = '$Day' WHERE `doctor`.`Serial` = '$snoEdit'";
$result=mysqli_query($conn,$sql);
...
//insert to databse
$sql="INSERT INTO `doctor` (`Name`, `Profession`,`Day`) VALUES ('$Name', '$Profession', '$Day')";
$result=mysqli_query($conn,$sql);
    ...
    <div class="modal-content">
      ...
      <form  action="doctor.php" method="post">
        <input type="hidden" name="snoEdit" id="snoEdit">
            ...
            <div class=" form-group">
              <label for="ProfessionEdit" class="form-label">Profession Edit</label>
              <input type="text" class="form-control" name="ProfessionEdit" id="ProfessionEdit" aria-describedby="ProfessionEdit">
            </div>
            <div class=" form-group">
   ...
   <a href="adminlogin.php" class="nav-item nav-link">Login</a>
          ...
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu m-0">
                <a href="doctor.php" class="dropdown-item active">Doctor</a>
...
<div class="mb-3 ">
              ...
              <input type="text" class="form-control" name="Profession" id="Profession" aria-describedby="Profession">
</div>
<div class="mb-3 ">
    ...
    Array.from(edits).forEach((element)=>{
      element.addEventListener("click",(e)=>{
        ...
        Name=tr.getElementsByTagName("td")[0].innerText;
         Profession=tr.getElementsByTagName("td")[1].innerText;
         Day=tr.getElementsByTagName("td")[2].innerText;
         console.log(Name,Profession,Day);
         NameEdit.value=Name;
      ...
      element.addEventListener("click",(e)=>{
        ...
        snoDelete=e.target.id.substr(1,);
         if(confirm("Press a button!")){
          console.log("yes");
          window.location=`doctor.php?delete=${snoDelete}`;
         }
         else{
          console.log("no");
         }
