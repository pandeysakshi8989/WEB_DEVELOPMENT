...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>HealthEasy - testimonial</title>
  ...
  <body>
          ...
          <div class="col-lg-7">
            ...
            >
              <div class="testimonial-item text-center text-white">
                ...
                />
                <p class="fs-5">
                  I am glad to tell you that HealthEasy provides best
                  counselling session and now I am doing well at my workplace.
                </p>
              ...
              <div class="testimonial-item text-center text-white">
                ...
                />
                <p class="fs-5">
                  I am very happy to tell that my surgery for brain tumour is
                  successfully completed by HelathEasy Team and now I am living
                  my greenery life.
                </p>
                <hr class="mx-auto w-25" />
    ...
    <!--Reviews-->
    <div class="row justify-content-evenly pt-5 pb-5 bg-danger">
      <h3 class="text-center pb-4">Reviews</h3>
      <div class="col-md-10">
        <div
            ...
            >
              <div class="accordion-body">
                ...
                <div class="row justify-content-evenly">
                  <div class="col-3">fghgjh@gmail.com</div>
                  <div class="col-4">Timely & Accurate ;sometime delay in night</div>
                  <div class="col-3">Rating:4/5</div>
                </div>

                <div class="row justify-content-evenly">
                  <div class="col-3">ghjhjjk@gmail.com</div>
                  <div class="col-4">Somewhat delay & Accurate;Technician seems frustated</div>
                  <div class="col-3">Rating:3/5</div>
                </div>
          ...
          <div class="accordion-item">
            ...
            >
              <div class="accordion-body">
                <div class="row justify-content-evenly">
                  <div class="col-3">fghgjh@gmail.com</div>
                  <div class="col-4">Very Supportive & Understable</div>
                  <div class="col-3">Rating:5/5</div>
                </div>

                <div class="row justify-content-evenly">
                  <div class="col-3">ghjhjjk@gmail.com</div>
                  <div class="col-4">It was fine;Counsellor seems in hurry</div>
                  <div class="col-3">Rating:2/5</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            ...
            >
              <div class="accordion-body">
                <div class="row justify-content-evenly">
                  <div class="col-3">fghgjh@gmail.com</div>
                  <div class="col-4">Well working! I want to give thumps up</div>
                  <div class="col-3">Rating:5/5</div>
                </div>

                <div class="row justify-content-evenly">
                  <div class="col-3">ghjhjjk@gmail.com</div>
                  <div class="col-4">Overall good;no management if crowded on Mon-Tue</div>
                  <div class="col-3">Rating:4/5</div>
                </div>
              </div>
            </div>
          ...
          <div class="accordion-item">
              ...
              >
                <div class="accordion-body">
                  <div class="row justify-content-evenly">
                    <div class="col-3">fghgjh@gmail.com</div>
                    <div class="col-4">Good and Comfortable Environment</div>
                    <div class="col-3">Rating:5/5</div>
                  </div>
  
                  <div class="row justify-content-evenly">
                    <div class="col-3">ghjhjjk@gmail.com</div>
                    <div class="col-4">Excellent dealing in case of complexity</div>
                    <div class="col-3">Rating:5/5</div>
                  </div>
                </div>
              </div>
